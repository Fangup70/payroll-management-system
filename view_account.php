                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    ...
                    <select name="deduction" class="form-control" required>
                      ...
                      <option value="<?php echo $phil; ?>">MEDICAL</option>
                      <option value="<?php echo $bir; ?>">PF</option>
                      <option value="<?php echo $gsis; ?>">INCOME TAX</option>
                      <option value="<?php echo $love; ?>">PROFESSION TAX</option>
